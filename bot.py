...
def main_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        # 1-й ряд (вершина) — главная кнопка
...
# ========== ОСТАЛЬНЫЕ ОБРАБОТЧИКИ (roulette, referrals, withdraw, leaders) ==========
# ... (они такие же, как в предыдущей версии, я их не менял для краткости, но в полном коде они есть)
